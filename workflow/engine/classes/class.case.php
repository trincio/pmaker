...
function arrayRecursiveDiff($aArray1, $aArray2) {
  ...
  */
  ...
  /*
  * Start a case
  * @Description:  This function start a case using the task for the user $sUsrUid
  * @param string $sTasUid
  * @param string $sUsrUid
  * @return Fields
  */
...
// NEW QUERY
  ...
  */
  ...
  function getConditionCasesList($sTypeList = 'all', $sUIDUserLogged = '', $ClearSession=true)
  {
    $c = new Criteria('workflow');
    $c->clearSelectColumns();
    ...
    if ($sTypeList != 'gral' && $sTypeList != 'to_revise' && $sTypeList != 'to_reassign' && $sTypeList != 'my_started') {
