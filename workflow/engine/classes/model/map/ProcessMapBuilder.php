...
class ProcessMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addValidator('PRO_STATUS', 'validValues', 'propel.validator.ValidValuesValidator', 'ACTIVE|INACTIVE', 'Please select a valid Process Status.');
