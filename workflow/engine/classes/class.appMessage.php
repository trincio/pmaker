...
class Process extends PmObject
{
    ...
    if ($sUID !== '')
  	{
  		...
  		/** Start Comment: Charge PRO_TITLE and PRO_DESCRIPTION */
  ...
  **/
  ...
  function save ($fields)
  {
		$this->Fields = array(
														...
														'PRO_OWNER_USER'    => (isset($fields['PRO_OWNER_USER'])   ? $fields['PRO_OWNER_USER']      : $this->Fields['PRO_OWNER_USER']),
														...
														'PRO_DEPARTMENT'    => (isset($fields['PRO_DEPARTMENT'])   ? $fields['PRO_DEPARTMENT']      : $this->Fields['PRO_DEPARTMENT']),
