...
$oNode        =& $oTree->addChild('4', '<a class="linkInBlue" href="#" onclick="showUploadedDocuments();return false;">' . G::LoadTranslation('ID_UPLOADED_DOCUMENTS') . '</a>', array('nodeType'=>'parentBlue'));
$oNode->plus  = '';
$oNode->minus = '';
$oNode->point = '';
