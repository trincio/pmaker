...
var ALFA = 1, INTEGER = 2, REAL=3, ANY = 4, ALFANUM = 5; FIELD=6;
...
function IsKeyValid ( mode ) {
  ...
  car = String.fromCharCode( window.event.keyCode );
    ...
    {left = (window.screen.availWidth  - 200) /2;
      ...
      <?
        ...
        if ($URI_VARS[0] != "" ) 
          ...
          print "var prePath = '';";
      ?>
   if ( pre_path == 1 ) prePath = '';   
 var obj_calwindow = window.open(
		prePath + '../controls/calendar?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
